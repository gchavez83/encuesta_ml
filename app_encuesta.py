...
edad= form.number_input('edad', min_value = 18 , max_value = 100, value=50 , format = '%d', step = 1)
califica_presidente= form.number_input('califica_presidente', min_value = 0 , max_value = 10, value=5 , format = '%d', step = 1)
califica_gobernador= form.number_input('califica_gobernador', min_value = 0 , max_value = 10, value=5 , format = '%d', step = 1)
